...
uses
  ...
  Data.Provider.UDP.Test in 'Data\Provider\UDP\Data.Provider.UDP.Test.pas' {dmProviderUDPTest: TDataModule} ,
  Data.Provider.UDP.Server in 'Data\Provider\UDP\Data.Provider.UDP.Server.pas' {dmProviderUDPServer: TDataModule} ,
